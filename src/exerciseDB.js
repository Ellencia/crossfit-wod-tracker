...
export const PATTERNS   = ['전체', '스쿼트', '힌지', '수직 밀기', '수평 밀기', '수직 당기기', '수평 당기기', '전신/올림픽', '코어', '유산소'];

export const EXERCISES = [
  // ── 올림픽 리프팅 ──────────────────────────────────────────
  { id: 'clean', name: 'Clean', nameKo: '클린', category: '올림픽 리프팅', pattern: '전신/올림픽',
  ...
  { id: 'power_clean', name: 'Power Clean', nameKo: '파워 클린', category: '올림픽 리프팅', pattern: '전신/올림픽',
  ...
  { id: 'hang_clean', name: 'Hang Clean', nameKo: '행 클린', category: '올림픽 리프팅', pattern: '전신/올림픽',
  ...
  { id: 'hang_power_clean', name: 'Hang Power Clean', nameKo: '행 파워 클린', category: '올림픽 리프팅', pattern: '전신/올림픽',
    muscles: { quadriceps:'high', gluteal:'high', hamstring:'high', trapezius:'high', 'lower-back':'medium', calves:'high', forearm:'medium' } },
  { id: 'clean_pull', name: 'Clean Pull', nameKo: '클린 풀', category: '올림픽 리프팅', pattern: '힌지',
    muscles: { quadriceps:'high', gluteal:'high', hamstring:'high', 'lower-back':'high', trapezius:'high', calves:'medium', abs:'low' } },
  { id: 'snatch', name: 'Snatch', nameKo: '스내치', category: '올림픽 리프팅', pattern: '전신/올림픽',
  ...
  { id: 'power_snatch', name: 'Power Snatch', nameKo: '파워 스내치', category: '올림픽 리프팅', pattern: '전신/올림픽',
  ...
  { id: 'hang_snatch', name: 'Hang Snatch', nameKo: '행 스내치', category: '올림픽 리프팅', pattern: '전신/올림픽',
  ...
  { id: 'snatch_pull', name: 'Snatch Pull', nameKo: '스내치 풀', category: '올림픽 리프팅', pattern: '힌지',
    muscles: { quadriceps:'high', gluteal:'high', hamstring:'high', 'lower-back':'high', trapezius:'high', calves:'medium' } },
  { id: 'clean_and_jerk', name: 'Clean & Jerk', nameKo: '클린 앤 저크', category: '올림픽 리프팅', pattern: '전신/올림픽',
  ...
  { id: 'assault_bike', name: 'Assault Bike / Echo Bike', nameKo: '어설트 바이크', category: '유산소', pattern: '유산소',
